      ...
      <div className="flex flex-col items-center justify-start max-h-screen h-screen w-screen m-auto">
        ...
        <div className="h-full max-w-full relative object-contain aspect-[4/3]">
          ...
          <div 
            ...
            ${firstLoad && "opacity-0"} ${servicesScreen === 1 && "transition-opacity delay-700 duration-1000 opacity-100"} ${mainScreen && "transition-opacity duraiton-700 opacity-0"}`}
          >
            <ul className="list-disc text-2xl md:text-3xl">
        ...
        <div className="mt-6 md:mt-8 lg:mt-12 lg:mb-8">
          ...
          {/* MAIN SCREEN */}
          <div className="flex-row justify-between w-screen lg:w-[75vw]" style={{display: mainScreen ? "flex": "none"}}>
          ...
          <div className={`${servicesScreen === 1 ? "block": "hidden"}`}>
            <Button onClick={fromServices}> Back </Button>
          </div>
